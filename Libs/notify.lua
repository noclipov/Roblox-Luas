...
local PRESETS = {
    ...
    Ice = Color3.fromRGB(186, 230, 253), -- Ледяной синий (очень светлый, кристальный)
    ...
    Vanilla = Color3.fromRGB(254, 243, 199), -- Теплый ванильный (кремовый)

    -- Темные акценты (стильные, приглушенные, отлично подходят для незаметных логов)
    Obsidian = Color3.fromRGB(31, 41, 55),    -- Темный обсидиан (глубокий серый уголь)
    Midnight = Color3.fromRGB(17, 24, 39),    -- Полночный синий (почти черный с синим отливом)
    Plum = Color3.fromRGB(76, 29, 149),   -- Темная слива (богатый приглушенный фиолетовый)
    Wine = Color3.fromRGB(127, 29, 29),   -- Винный (благородный темно-бордовый)
    Forest = Color3.fromRGB(6, 78, 59),     -- Хвойный лес (глубокий темно-зеленый)
    Gunmetal = Color3.fromRGB(55, 65, 81),    -- Оружейная сталь (матовый сине-серый тон)
}
